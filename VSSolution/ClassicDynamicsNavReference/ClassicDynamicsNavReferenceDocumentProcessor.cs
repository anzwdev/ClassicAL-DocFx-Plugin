...
namespace ClassicDynamicsNavReference
{
    ...
    public class ClassicDynamicsNavReferenceDocumentProcessor : ReferenceDocumentProcessorBase
    {
        ...
        protected override string ProcessedDocumentType => Constants.ClassicDynamicsNavReferenceName;
        ...
        [ImportMany(nameof(ClassicDynamicsNavReferenceDocumentProcessor))]
        public override IEnumerable<IDocumentBuildStep> BuildSteps { get; set; }

        public override string Name => nameof(ClassicDynamicsNavReferenceDocumentProcessor);
            ...
            switch (file.Type)
            {
                case DocumentType.Article:
                        ...
                        ".yaml".Equals(Path.GetExtension(file.File), StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        switch (mime)
                        {
                            case Constants.ClassicDynamicsNavReferenceYamlMime:
