...
using Microsoft.DocAsCode.Build;
using Microsoft.DocAsCode.Plugins;

namespace ClassicDynamicsNavReference
{

    [Export(nameof(ClassicDynamicsNavReferenceDocumentProcessor), typeof(IDocumentBuildStep))]
    public class BuildClassicDynamicsNavDocument : BuildReferenceDocumentBase
    {

        public override string Name => nameof(BuildClassicDynamicsNavDocument);
